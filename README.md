...
- `/watchlist` is protected and shows signed-in users their default-portfolio watchlist with target prices, notes, linked stock symbols, and latest cached close prices when available.
